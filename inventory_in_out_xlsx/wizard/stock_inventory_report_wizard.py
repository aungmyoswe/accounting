...
class inventory_reports_wizard(models.TransientModel):    
    _inherit = 'inventory.in.out.reports'   
    ...
    def print_report_xlsx(self):
        ...
        """
        data_obj = self.env['report.inventory_in_out_xlsx.inventory_report_by_warehouse']
        data_obj_cat = self.env['report.inventory_in_out_xlsx.inventory_report_by_category']
